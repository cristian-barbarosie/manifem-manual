...
\begin{Verbatim}[commandchars=\\\{\},formatcom=\small\tt,frame=single,
   ...
   RR2 .implicit ( x*y - x - y ==  \laranja{1.} );
   \verm{Mesh} \azul{WS} ( \textcolor{tag}{tag}::frontal, \textcolor{tag}{tag}::start_at, W, \textcolor{tag}{tag}::stop_at, S, \textcolor{tag}{tag}::desired_length, \laranja{0.1} );
   \cinza{// ... //}
...
\ref{\numb section 3.\numb parag 23} (by setting a non-constant desired length).
