...
\begin{Verbatim}[commandchars=\\\{\},formatcom=\small\tt,
   ...
   \verm{Mesh} \azul{arc_of_circle} ( \textcolor{tag}{tag}::progressive, \textcolor{tag}{tag}::start_at, A,
                        \textcolor{tag}{tag}::stop_at, B, \textcolor{tag}{tag}::desired_length, \mbox{\fontfamily{helvetica}\selectfont{}some\_\,value} );
\end{Verbatim}
...
Each of the constructors {\small\tt\verm{Mesh} circle\_\,1} and {\small\tt\verm{Mesh} circle\_\,2}
