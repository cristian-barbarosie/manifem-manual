...
performs, under the curtains, a projection on the current working {\small\tt\verm{Manifold}} :
...
\begin{Verbatim}[commandchars=\\\{\},formatcom=\small\tt,frame=single,
   label=parag-\ref{\numb section 2.\numb parag 12}.cpp,rulecolor=\color{moldura},
   baselinestretch=0.94,framesep=2mm]
   \verm{Manifold} \azul{four_points} ( \textcolor{tag}{tag}::intersection, parab_vert, parab_horiz );
\end{Verbatim}
...
Here is a three-dimensional version of the diamond.
