...
\ref{\numb section 2.\numb parag 14},
\ref{\numb section 2.\numb parag 15}, \ref{\numb section 2.\numb parag 18} and
\ref{\numb section 2.\numb parag 19} focus on two-dimensional meshes
in $ \mathbb{R}^3 $ (surfaces).
Paragraph \ref{\numb section 2.\numb parag 12} shows a volumic mesh, made of cubic cells.
...
Paragraph \ref{\numb section 2.\numb parag 15} shows a way to control the shape of the segments
...
%\vskip -3mm
\if\production 1
\centerline{\includegraphics[width=75mm]{dry-physalis}}
\else
...
In the approach of paragraph \ref{\numb section 2.\numb parag 16}, it is possible but cumbersome to
...
\ref{\numb section 2.\numb parag 17} is possible but not practical.
