...
mesh of triangles, then {\small\tt msh.core->cells[\laranja{0}]} is a list of (wrappers) of
each vertex of that mesh, {\small\tt msh.core->cells[\laranja{1}]} is a list of (wrappers) of
each segment and {\small\tt msh.core->cells[\laranja{2}]} is a list of (wrappers) of each triangle.
