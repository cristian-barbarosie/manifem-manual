...
\begin{Verbatim}[commandchars=\\\{\},formatcom=\small\tt,frame=single,
   label=parag-\ref{\numb section 7.\numb parag 13}.cpp,rulecolor=\color{moldura},
   baselinestretch=0.94,framesep=2mm                                             ]
...
so the manifold we are dealing with is Riemannian.
...
\ref{\numb section 7.\numb fig 12}) which do not interfere in the process.
...
We use a {\small\tt\verm{Function}} as {\small\tt\textcolor{tag}{tag}::desired\_\,length}
...
\begin{figure}[ht] \centering
  ...
  \includegraphics[width=70mm]{hexagon-bdry.eps}
...
Figure \ref{\numb section 7.\numb fig 14} shows the resulting mesh, together with the
periodicity cell.
...
Figure \ref{\numb section 7.\numb fig 15} shows the resulting mesh.


                    %-----------------------------------------%
\section{~~\cinzasec{Progressive meshing on quotient manifolds}}
                    %-----------------------------------------%
\label{\numb section 7.\numb parag 20}
