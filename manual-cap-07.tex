...
An interesting question is whether we can extend the mesh to the origin
(see figure \ref{\numb section 7.\numb fig 7}).
...
\end{Verbatim}
          ...
          %-----------------------------%
\section{~~Avoiding degenerate triangles}\label{\numb section 7.\numb parag 13}
          %-----------------------------%
...
Figure \ref{\numb section 7.\numb fig 12} shows the resulting mesh, together with the
periodicity cell.
