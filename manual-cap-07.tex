...
A {\small\tt\verm{tag}::build\_\,new\_\,vertices} says that new vertices must be built
and geometric coordinates copied from the old vertices to the new ones.
A {\small\tt\verm{tag}::use\_\,existing\_\,vertices} says that old vertices must be used
