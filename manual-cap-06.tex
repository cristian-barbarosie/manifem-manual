...
he purpose of a {\small\tt\verm{FiniteElement}} is to build a list of functions, say, $ \psi $,
defined on our mesh.
...
Often, we view finite elements as acting at cell level.
...
it is enough to declare an {\small\tt\verm{Integrator}}.
...
\begin{Verbatim}[commandchars=\\\{\},formatcom=\small\tt,frame=single,
   label=parag-\ref{\numb section 6.\numb parag *}.cpp,rulecolor=\color{moldura},
...
given {\small\tt\verm{Integrator}}, triangular Lagrange P1 in this case
...
The final operation, of finding the value of the integral, does not involve symbolic computations
because it uses Gauss quadrature.
