...
After declaring a finite element of type Lagrange with {\small\tt\verm{tag}::enumerate\_\,cells},
...
{\small\tt\verm{tag}::enumerate\_\,cells} when declaring {\small\tt fe} and not when
