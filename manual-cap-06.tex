...
for a {\small\tt\verm{FiniteElement}::Core}.
...
{\small\tt\verm{FiniteElement}::WithMaster::Segment}, {\small\tt Triangle} and
{\small\tt Quadrangle}.
...
In this section we show another type of finite elements.
...
they will be computed all at the same time.
...
{\ManiFEM} is under construction and many types of finite elements and of integrators are
still missing.
...
You may call this method just after the declaration of the element and get generic information,
or after {\small\tt pre\_\,compute} and get information specific to the expressions
