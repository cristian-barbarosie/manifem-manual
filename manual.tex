...
see at the end of paragraph \ref{\numb section 6.\numb parag 2}.
...
\noindent
code coloring : see source text colouring

% \noindent
% coloring conventions for code samples : see source text colouring
