...
\def\manifemrelease{22.02}
\def\manualversion{22.02}
\let\production 0
\includeonly{manual-cap-05,manual-cap-06}
% \usepackage{showkeys}
...
\noindent Rename {\small\tt\verm{Mesh}::export\_\,msh} to
{\small\tt\verm{Mesh}::export\_\,to\_\,file}.
Switch to {\small\tt gmsh} version 4 format.          

\noindent Introduce constructor {\small\tt\verm{Mesh}} {\small\tt \azul{msh}} {\small\tt (}
{\small\tt\textcolor{tag}{tag}::cube,} {\small\tt ...} {\small\tt )}.
