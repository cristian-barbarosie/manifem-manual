...
\let\production 0
\includeonly{manual-cap-10,manual-cap-11}
% \usepackage{showkeys}
...
\subparagraph*{\ref{\numb section 3} \ Progressive mesh generation; cross-stitch}
...
\noindent Introduced iterators around a cell,
paragraph \ref{\numb section 9.\numb parag 10}.

\noindent Some examples about remeshing, section \ref{\numb section 10}.


\section*{21.\manifemrelease}

\noindent Minor improvements and bug fixes.
