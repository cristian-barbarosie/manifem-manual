...
\noindent Optimized, hand-coded finite elements are on their way,
see comments at the end of paragraph \ref{\numb section 6.\numb parag 2}.
They work for P1 triangles and Q1 quadrangles (some cases still missing for quadrangles).
They should be extended to many other types of finite elements.

\noindent I implemented a class for multi-indexed matrices
...
\noindent
{\small\tt\verm{Mesh}::export\_\,msh} : {\numb section 1.\numb parag 1},
{\numb section 1.\numb parag 3}
...
\noindent
{\small\tt\verm{Mesh}::Iterator::in\_\,range} : {\numb section 9.\numb parag 3}
