...
{\small\tt \verm{Mesh}} constructors with {\small\tt \verm{tag}::rectangle} or
...
Methods {\small\tt\verm{Cell}::add\_\,to\_\,mesh} and
{\small\tt\verm{Cell}::remove\_\,from\_\,mesh} accept as second argument a\break
{\small\tt\verm{tag}::do\_\,not\_\,bother}.
...
By providing a {\small\tt\verm{tag}::do\_\,not\_\,bother}, the user instructs
...
{\small\tt\verm{tag}::build\_\;enum} builds a new
