...
Paragraphs \ref{\numb section 1.\numb parag 4} and \ref{\numb section 3.\numb parag 18}
show examples where the orientation of the common boundary is important for joining meshes.
...
\begin{Verbatim}[commandchars=\\\{\},formatcom=\small\tt,frame=single,
   ...
   baselinestretch=0.94,framesep=2mm]
   \verm{Mesh cube} ( \textcolor{tag}{tag}::cube, ABCD, HGFE, BFGC, DHEA, CGHD, AEFB );
\end{Verbatim}
...
Just like for two-dimensional meshes, the orientation of the resulting mesh is determined
