...
{\small\tt\textcolor{tag}{tag}::rectangle,...)} calls the {\small\tt\verm{Mesh}::build} method
...
{\small\tt\verm{Cell}}s is that we can navigate through is as described in paragraph
\ref{\numb section 9.\numb parag 6}.
