...
The {\small\tt \verm{Mesh}} constructor with {\small\tt \verm{tag}::segment}
calls the {\small\tt\verm{Mesh}::build} method with {\small\tt \verm{tag}::segment}.
...
{\small\tt \verm{Cell}} {\small\tt(} {\small\tt\verm{tag}::vertex} {\small\tt)}.
...
{\small\tt\verm{tag}::segment,} {\small\tt A,} {\small\tt B} {\small\tt )},
...
Constructor {\small\tt \verm{Mesh}::Mesh} {\small\tt(} {\small\tt\verm{tag}::rectangle,...)}
calls the {\small\tt\verm{Mesh}::build} method with {\small\tt \verm{tag}::rectangle}.
...
\begin{figure}[ht] \centering
  ...
  \psfrag{south}{\tt\textcolor{textindraw}{south}}
  \psfrag{east}{\tt\textcolor{textindraw}{east}}
  \psfrag{north}{\tt\textcolor{textindraw}{north}}
  \psfrag{west}{\tt\textcolor{textindraw}{west}}
...
Providing a {\small\tt \verm{tag}::with\_triangles} makes the constructor cut each rectangle
...
\begin{figure}[ht] \centering
  ...
  \psfrag{P_AB}{\tt\textcolor{textindraw}{P\_AB}}
  \psfrag{Q_AB}{\tt\textcolor{textindraw}{Q\_AB}}
  \psfrag{P_BC}{\tt\textcolor{textindraw}{P\_BC}}
  \psfrag{Q_BC}{\tt\textcolor{textindraw}{Q\_BC}}
  \psfrag{P_CA}{\tt\textcolor{textindraw}{P\_CA}}
  \psfrag{Q_CA}{\tt\textcolor{textindraw}{Q\_CA}}
...
{\small\tt\verm{tag}::progressive,...)} are defined in {\small\tt progressive.cpp};
...
\begin{figure}[ht] \centering
  \psfrag{A}{\tt\textcolor{textindraw}{A}}
  \psfrag{B}{\tt\textcolor{textindraw}{B}}
  \psfrag{P}{\tt\textcolor{textindraw}{P}}
  \psfrag{point60}{\tt\textcolor{textindraw}{point\_60}}
  \psfrag{point120}{\tt\textcolor{textindraw}{point\_120}}
...
We use a {\small\tt\verm{MetricTree}} with (the square of) the usual Euclidian distance (which is
computationally cheap).
This means that a call to {\small\tt\verm{MetricTree}:: ::find\_close\_neighbours\_of}
